...
**Empfehlungs-Engine** — Hebt Reinigendes Gebräu bzw. den Schild-Zauber durch Pulsieren und/oder Leuchten hervor:

*Reinigendes Gebräu* (119582) — bis Midnight „Läuterndes Gebräu"
...
Sämtliche Schwellen sind Heuristiken und über das Optionsfenster anpassbar – auch der Anteil, den Reinigendes Gebräu entfernt (Standard 60 %) und sein Sockelbetrag (Standard 8 % max. Leben), falls sich das Balancing ändert.
...
lua5.1 tests/run_tests.lua            # 138 Prüfungen gegen die API-Attrappe
...
- **Gesperrte Werte unter Midnight:** Der Client gibt `UnitHealth("player")` sowie
  ...
  **keine** Aussage: Die beiden Notfall-Empfehlungen (Reinigen bzw. Schild unterhalb
...
- Die Empfehlungswerte sind Heuristiken, keine Simulation. Der Tooltip nennt „bis zu
  60 % des gestaffelten Schadens oder mindestens 8 % der maximalen Gesundheit"; beide
  Werte sind konfigurierbare Startwerte, falls sich das Balancing ändert.
